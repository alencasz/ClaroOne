...
- Taxonomia centralizada na CCE: Faturamento, Internet, Telefonia, Cancelamento e Outros, cada uma com um departamento de destino coerente.
...
Consulte `LEIA_PRIMEIRO.txt` para o passo a passo curto e `DOCUMENTACAO_TECNICA.txt` para a descrição objetiva da arquitetura e das APIs.
